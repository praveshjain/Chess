...
public class ChessTest extends TestCase {
    ...
    public void testPawnForwardMove() throws Exception{
        String fen = board.tryMove("e4");
        assertEquals(fen, "rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq f4 0 1");
    }
...
//    public void testGameofTheCentury() throws Exception{
